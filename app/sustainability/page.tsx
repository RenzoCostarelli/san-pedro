    ...
    <>
      <Hero image={sustainabilityImg}>
        <div className="flex">
          <div className="container mx-auto relative z-50">
            <h1 className="font-alegreya-sans text-8xl">Sustainability</h1>
      ...
      <section className="bg-blue py-15 md:px-0 px-5">
        ...
        <div>
          {items.map((item, index) => (
            <div
              key={index}
              className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10 group"
            >
              <div className="group-even:order-2 grid md:grid-cols-6">
                <div className="group-even:col-end-6 col-start-2 group-even:col-start-1 col-span-6">
      ...
      <section className="bg-blue py-15 md:px-0 px-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10 group">
          ...
          <div className="group-even:order-1">
            <Image src={energieImg} alt="" className="clip-reverse" />
          </div>
        </div>
      </section>
    </>
